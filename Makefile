...
# egeria-project.org/egeria-bundle:$VERSION and egeria-project.org/egeria-catalog:$VERSION.
IMAGE_TAG_BASE ?= egeria-project.org/egeria
...
.PHONY: rebuild
rebuild: kustomize controller-gen envtest generate manifests install
...
clean-runit:
	...
	bin/kustomize build config/default | kubectl delete --ignore-not-found=$(ignore-not-found) -f - || true
