...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EgeriaStorageSpec) DeepCopyInto(out *EgeriaStorageSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EgeriaStorageSpec.
func (in *EgeriaStorageSpec) DeepCopy() *EgeriaStorageSpec {
	if in == nil {
		return nil
	}
	out := new(EgeriaStorageSpec)
	in.DeepCopyInto(out)
	return out
}
